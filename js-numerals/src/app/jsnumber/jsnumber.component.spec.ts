...
describe('JsnumberComponent', () => {
  ...
  it(`should display a phrase describing a number 'js-numerals'`, () => {
    ...
    fixture.detectChanges();
    let compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('h3').textContent).toEqual('42 == forty two ');
  });
  ...
  it(`should display a phrase describing a number 'js-numerals'`, () => {
    ...
    fixture.detectChanges();
    let compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('h3').textContent).toEqual('2001 == two thousand one ');
  });
  ...
  it(`should display a phrase describing a number 'js-numerals'`, () => {
    ...
    fixture.detectChanges();
    let compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('h3').textContent).toEqual('1999 == one thousand nine hundred ninety nine ');
  });
  ...
  it(`should display a phrase describing a number 'js-numerals'`, () => {
    ...
    fixture.detectChanges();
    let compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('h3').textContent).toEqual('17999 == seventeen thousand nine hundred ninety nine ');
  });
